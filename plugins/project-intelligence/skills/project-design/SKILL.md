...
5. In standalone mode, write Bugs as `<bug-id>-<name>-设计文档.md` and Requirements as `<requirement-id>_<name>_设计文档.md`. In lifecycle mode always use the resolved `.project-intel/requirements/<id>-<title>/<id>-<title>-设计文档.md`. Reject path separators, control characters, and output outside the primary repository.
