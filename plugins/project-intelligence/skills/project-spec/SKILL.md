---
name: project-spec
description: Use after project-intake and before project-debug/project-design to create or register the requirement document and persist matching numbered acceptance criteria. 写需求文档, 整理需求, 需求澄清, 补充验收标准, 生成需求/Bug文档, acceptance criteria. Do not use for source-backed technical design or execution-task planning.
---
...
Confirm numbered, testable acceptance criteria, write the same IDs into the titled requirement/Bug document, and persist them in the manifest before registering the completed document:
