...
project-intel --project /path/to/repo intake --requirement-id REQ-1001 --requirement-name "新需求" --version-date 2026-07-23 --ticket-kind requirement --external-api no --requirement-action generate --design-action generate
...
project-intel --project /path/to/repo requirement add --requirement-id REQ-1001 --type requirement --path .project-intel/requirements/2026-07-23-REQ-1001-新需求/REQ-1001-新需求-需求文档.md
...
project-intel --project /path/to/repo requirement add --requirement-id REQ-1001 --type design --path .project-intel/requirements/2026-07-23-REQ-1001-新需求/REQ-1001-新需求-设计文档.md
