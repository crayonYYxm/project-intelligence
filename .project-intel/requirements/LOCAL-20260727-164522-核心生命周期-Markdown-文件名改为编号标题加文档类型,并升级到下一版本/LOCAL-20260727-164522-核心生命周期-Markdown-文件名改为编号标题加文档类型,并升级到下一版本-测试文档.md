# 核心生命周期 Markdown 文件名改为编号标题加文档类型，并升级到下一版本 · 测试报告
...
- AC-01：已记录证据 — 新建需求/Bug 的核心 Markdown 文件名使用编号-标题-文档类型.md
- AC-02：已记录证据 — requirement 文档按单据类型区分为需求文档或Bug文档，设计/测试/收口使用设计文档/测试文档/收口文档
- AC-03：已记录证据 — 旧 requirement.md/design.md/test-report.md/closure-summary.md 仍可读取和登记，不破坏历史档案
- AC-04：已记录证据 — package、运行时版本和插件 manifest 升级到下一 patch 版本并保持发布校验通过
- AC-05：已记录证据 — 新生成的需求、设计、测试、收口文档内容结构对齐样例目录中的 PRD、设计、测试和收口档案标准
