...
- AC-01：已记录证据 — ZCode 可从仓库根目录 marketplace 发现插件，并优先读取 .zcode-plugin/plugin.json；npm 包包含两份 ZCode 清单。
- AC-02：已记录证据 — Git 跟踪文件和 npm 包内不存在符号链接，Windows/ZCode 克隆不再因链接权限失败。
- AC-03：已记录证据 — 需求级测试命令每次记录证据后都会创建或更新 .project-intel/requirements/<id>/test-report.md，内容包含各次实际执行结果与验收标准映射。
- AC-04：已记录证据 — 评审通过后直接执行 project-intel finish 会自动创建并登记 closure-summary.md；门禁失败时不会留下收口文档。
- AC-05：已记录证据 — 现有 Claude Code、Codex、测试门禁、完整测试套件和发布包检查保持通过。
...
- 文件范围：src/__tests__/review-finish-graph.test.ts, src/__tests__/test-evidence.test.ts, src/__tests__/zcode-compat.test.ts
- 明细报告：`.project-intel/requirements/LOCAL-20260724-181500/test-reports/TEST-01-unit.md`
...
- 结果：passed
- 验收标准：AC-01, AC-02, AC-03, AC-04, AC-05
- 文件范围：marketplace.json, package.json, plugins/project-intelligence/.zcode-plugin/plugin.json, scripts/check-package.mjs, scripts/check-release.mjs, src/__tests__/review-finish-graph.test.ts, src/__tests__/test-evidence.test.ts, src/__tests__/zcode-compat.test.ts, src/commands/finish.ts, src/commands/test.ts, src/requirements/state-machine.ts
- 明细报告：`.project-intel/requirements/LOCAL-20260724-181500/test-reports/TEST-02-unit.md`
...
- 验收标准：AC-01, AC-02, AC-03, AC-04, AC-05
- 文件范围：marketplace.json, package.json, plugins/project-intelligence/.zcode-plugin/plugin.json, scripts/check-package.mjs, scripts/check-release.mjs, src/__tests__/review-finish-graph.test.ts, src/__tests__/test-evidence.test.ts, src/__tests__/zcode-compat.test.ts, src/commands/finish.ts, src/commands/test.ts, src/requirements/state-machine.ts
- 明细报告：`.project-intel/requirements/LOCAL-20260724-181500/test-reports/TEST-03-unit.md`
...
- 结果：passed
- 验收标准：AC-01, AC-02, AC-03, AC-04, AC-05
- 文件范围：marketplace.json, package.json, plugins/project-intelligence/.zcode-plugin/plugin.json, scripts/check-package.mjs, scripts/check-release.mjs, scripts/gen-version.mjs, src/__tests__/review-finish-graph.test.ts, src/__tests__/test-evidence.test.ts, src/__tests__/zcode-compat.test.ts, src/commands/finish.ts, src/commands/test.ts, src/requirements/state-machine.ts, src/testing/render.ts
- 明细报告：`.project-intel/requirements/LOCAL-20260724-181500/test-reports/TEST-04-unit.md`
